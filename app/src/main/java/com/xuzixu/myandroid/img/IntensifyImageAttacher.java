...
public class IntensifyImageAttacher implements View.OnTouchListener {
    ...
    public IntensifyImageAttacher(IntensifyImageView intensifyView) {
        ...
        mScaleGestureDetector = new ScaleGestureDetector(context, new IntensifyImageAttacher.OnScaleGestureAdapter());
        mGestureDetector = new GestureDetector(context, new IntensifyImageAttacher.OnGestureAdapter());
